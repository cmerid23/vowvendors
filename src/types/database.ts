...
export interface Database {
  public: {
    Tables: {
      ...
      vendors: {
        Row: { id: string; user_id: string; business_name: string; category: 'photographer' | 'videographer' | 'decor' | 'music'; bio: string | null; state: string; city: string | null; phone: string | null; website: string | null; instagram_handle: string | null; starting_price: number | null; price_unit: string; is_featured: boolean; is_verified: boolean; is_active: boolean; avg_rating: number; review_count: number; style_tags: string[] | null; created_at: string }
        Insert: { id?: string; user_id: string; business_name: string; category: string; bio?: string | null; state: string; city?: string | null; phone?: string | null; website?: string | null; instagram_handle?: string | null; starting_price?: number | null; price_unit?: string; is_featured?: boolean; is_verified?: boolean; is_active?: boolean; style_tags?: string[] | null; created_at?: string }
        Update: { business_name?: string; category?: string; bio?: string | null; state?: string; city?: string | null; phone?: string | null; website?: string | null; instagram_handle?: string | null; starting_price?: number | null; price_unit?: string; is_active?: boolean; is_featured?: boolean; is_verified?: boolean; style_tags?: string[] | null }
      }
      portfolio_images: {
